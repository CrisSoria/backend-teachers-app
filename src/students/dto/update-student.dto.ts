...
import { IsOptional, IsString, IsMongoId, IsEnum, IsDate, IsNumber, Min } from 'class-validator';
...
export class UpdateStudentDto extends PartialType(CreateStudentDto) {
  ...
  @IsOptional()
  @IsEnum(StudentsGender, { message: 'El gender debe ser un género válido: '+Object.values(StudentsGender).join(', ') })
